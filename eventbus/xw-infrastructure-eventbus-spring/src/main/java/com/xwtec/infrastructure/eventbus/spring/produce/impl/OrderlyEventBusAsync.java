...
@Component("orderlyEventBusAsync")
public class OrderlyEventBusAsync implements IEventBusAsync {

    private static final Logger log = LoggerFactory.getLogger(OrderlyEventBusAsync.class);
    ...
    public void post(EventBusPayload message, Consumer<EventBusResult> consumer) {
        log.debug("OrderlyEventBusAsync");
        if (message != null) {
            try {
