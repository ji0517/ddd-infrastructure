...
import com.xwtec.infrastructure.uid.buffer.BufferPaddingExecutor;
import com.xwtec.infrastructure.uid.buffer.RejectedPutBufferHandler;
import com.xwtec.infrastructure.uid.buffer.RejectedTakeBufferHandler;
import com.xwtec.infrastructure.uid.buffer.RingBuffer;
 ...
 * @author wujun
 */
@ConfigurationProperties(prefix = "xw.uid.cached-uid-generator")
