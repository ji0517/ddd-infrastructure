...
import com.xwtec.infrastructure.uid.BitsAllocator;
import com.xwtec.infrastructure.uid.UidGenerator;
import com.xwtec.infrastructure.uid.exception.UidGenerateException;
import com.xwtec.infrastructure.uid.utils.DateUtils;
...
/**
 * Represents an implementation of {@link com.xwtec.infrastructure.uid.UidGenerator}
 * <p>
 ...
 * @author wujun
 */
public class DefaultUidGenerator implements com.xwtec.infrastructure.uid.UidGenerator, InitializingBean {
     ...
     */
    protected com.xwtec.infrastructure.uid.BitsAllocator bitsAllocator;
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        bitsAllocator = new com.xwtec.infrastructure.uid.BitsAllocator(uidProperties.getTimeBits(), uidProperties.getWorkerBits(), uidProperties.getSeqBits());
    ...
    public String parseUID(long uid) {
        long totalBits = com.xwtec.infrastructure.uid.BitsAllocator.TOTAL_BITS;
